...
namespace EFCoreRelationship.Controllers
{
    ...
    public class CharacterController : ControllerBase
    {
        ...
        {
            var character = await _context.Characters.Where(c => c.UserId == userId)
                .Include(c=> c.Weapon)
                .Include(c=> c.Skills)
                .ToListAsync();
            return Ok(character);
        ...
        [HttpPost("skill")]
        public async Task<ActionResult<List<Character>>> AddCharacterSkill(AddCharacterSkillDto request)
        {
